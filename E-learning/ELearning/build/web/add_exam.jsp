<%-- 
    Document   : add_exam
    Created on : Apr 10, 2012, 11:25:58 PM
    Author     : Admin
--%>
                            ...
                            <form action="AddExamServlet" method="post">
                                <table class="style1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ExamDate1" type="text" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ExamDate2" type="text" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ExamDate3" type="text" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ExamDate4" type="text" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ExamDate5" type="text" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="btnAdd" type="submit" value="Add Exam Details" />
                                        </td>
                                        <td>
                                            &nbsp;
                                        </td>
