<%-- 
    Document   : show_fees
    Created on : Apr 11, 2012, 12:39:06 AM
    Author     : Admin
--%>
                    ...
                    <div class="container_row">
                        <div class="welcomezone" style="font-size: 15px;">
                            <div class="blueboldheading">
                                <h1>
                                    Show Fees Structure Form :</h1>
                            </div>
                            <form action="ShowFeesServlet" method="post">
                                <table class="style1">
                                    <tr>
                                        <td>
                                            Select Course :
                                    ...
                                    <tr>
                                        <td>
                                            &nbsp;</td>
                                        <td>
                                            <input name="btnShow" type="submit" value="Show Fees Structure" /></td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <sql:query var="query3" dataSource="${dsn1}">
                                        Select * from feestable where CourseID =? AND Sem =?;
